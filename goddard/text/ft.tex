...
{\tt FTGET(H,TAB,FIELD,ROWS,[NULLS])}	\\
...
\exc{FTPRINT,h,tab, text=3}{;Write the entire table to an ASCII file, FTPRINT.PRT}
\exend
...
of star names, NAME.  Create a FITS table named ``star.fits''.
\exbegin
