...
shift_stamp_image=sshift2d(stamp_image,[fxlo,fylo])

; find overlapping region and add
full_nx=(size(full_image,/dimensions))[0]
full_ny=(size(full_image,/dimensions))[1]
shift_stamp_nx=(size(shift_stamp_image,/dimensions))[0]
shift_stamp_ny=(size(shift_stamp_image,/dimensions))[1]
full_xlo=ixlo > 0
...
if(shift_stamp_xlo ge 0 and shift_stamp_ylo ge 0 and $
   ...
   full_xhi gt full_xlo and full_yhi gt full_ylo) then $
  full_image[full_xlo:full_xhi-1L,full_ylo:full_yhi-1L]= $
  full_image[full_xlo:full_xhi-1L,full_ylo:full_yhi-1L]+ $
  shift_stamp_image[shift_stamp_xlo:shift_stamp_xhi-1L, $
