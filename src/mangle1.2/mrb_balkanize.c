		 ...
		 char *argv[];
{
	...
	npolys = mrb_balkanize(polys, npoly, &polys[npoly], NPOLYSMAX - npoly, 
...
{
	printf("usage:\n");
	printf("mrb_balkanize [-d] [-q] [-s<n>] [-e<n>] [-vo|-vn] [-p<n>] [-i<f>[<n>][u]] [-o<f>[u]] infile1 [infile2] ... outfile\n");
#include "usage.h"
}
